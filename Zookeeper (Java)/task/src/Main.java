...
//                """);
                ...
                System.out.println(animals[answer ]);
//                System.out.println("""
//                ---
//                You've reached the end of the program. To check another habitat, please restart the watcher.
//                """);
            ...
            System.out.println("If you would like to exit the program please type exit if not type skip: ");

            String endProgram = scan.nextLine();

            if (endProgram.equals(exit)) {
                endProgram = scan.nextLine();
                endProgram.toUpperCase();
